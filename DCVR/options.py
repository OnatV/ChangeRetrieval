...
class optionsDCVA():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataPath', required=False, help='path to the data. Data is assumed to be saved in a .mat file. with two variables - preChangeData and postChangeData')
        parser.add_argument('--inputChannels', type=str, default='RGB', help='input channels - can be RGB or RGBNIR')
        parser.add_argument('--layersToProcess', type=str, default='2,5,8,11', help='comma separated layers from which features are extracted, choose values from 2,5,8,10,11,23')
